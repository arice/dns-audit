...
- Removed client references from `CLAUDE.md`
...
- Missed a client reference on first review of `CLAUDE.md` — user caught it; should read more carefully before declaring files safe to push
